...
class CustomerTest {
    ...
    void buyProduct() {
        ...
        Applicant app1 = new Applicant("Joy", "Samuel", "07072738394", add1, Gender.FEMALE, "TRUE");
        ...
        cus1.buyProduct(product1);

        String msgSuccess = "Product Bought Successfully!";
        String msgFail = "Insufficient fund!";
          Assert.assertNotEquals(msgSuccess,cus1.buyProduct(product1));
    }
}